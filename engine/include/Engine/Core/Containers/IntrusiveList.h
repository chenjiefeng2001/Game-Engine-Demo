...
protected:
  ...
  IntrusiveListNode(IntrusiveListNode &&other) noexcept
      : m_Next(other.m_Next), m_Prev(other.m_Prev) {
    if (m_Next)
      static_cast<T *>(m_Next)->m_Prev = static_cast<T *>(this);
    if (m_Prev)
      static_cast<T *>(m_Prev)->m_Next = static_cast<T *>(this);
  ...
  void Unlink() noexcept {
    if (m_Prev)
      static_cast<T *>(m_Prev)->m_Next = m_Next;
    if (m_Next)
      static_cast<T *>(m_Next)->m_Prev = m_Prev;
    m_Next = nullptr;
    m_Prev = nullptr;
  }
