...
static void glad_gl_load_GL_MESA_map_buffer_client_pointer(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
    if(!context->MESA_map_buffer_client_pointer) return;
    context->AddClientPointerRangeMESA = (PFNGLADDCLIENTPOINTERRANGEMESAPROC) load(userptr, "glAddClientPointerRangeMESA");
    context->ReleaseClientPointerRangeMESA = (PFNGLRELEASECLIENTPOINTERRANGEMESAPROC) load(userptr, "glReleaseClientPointerRangeMESA");
}
...
static int glad_gl_find_extensions_gl(GladGLContext *context) {
    ...
    context->MESA_map_buffer_client_pointer = glad_gl_has_extension(exts, exts_i, "GL_MESA_map_buffer_client_pointer");
...
int gladLoadGLContextUserPtr(GladGLContext *context, GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_gl_load_GL_MESA_map_buffer_client_pointer(context, load, userptr);
